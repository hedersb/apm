...
public class AdaptivePenaltyMethod {
	...
	for (i = 0; i < constraintViolationValues.length; i++) {
	    ...
	    fitnessValues[ i] = infeasible
		    ? (objectiveFunctionValues[ i] > this.averageObjectiveFunctionValue? objectiveFunctionValues[ i] + penalization: this.averageObjectiveFunctionValue + penalization)
	...
	//otherwise
	return infeasible
	    ? (objectiveFunctionValue > this.averageObjectiveFunctionValue? objectiveFunctionValue + penalization: this.averageObjectiveFunctionValue + penalization)
